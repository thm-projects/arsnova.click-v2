...
import {QuestionRangedI} from "./QuestionRangedI";

export class RangedQuestion extends AbstractQuestion implements QuestionRangedI {
  ...
  private _correctValue: number = 0;
	 ...
	 */
	serialize (): Object {
		return Object.assign(super.serialize(), {type: this.TYPE, rangeMin: this.rangeMin, rangeMax: this.rangeMax, correctValue: this.correctValue});
	}
	 ...
	 */
	equals (question: QuestionRangedI): boolean {
