...
import {QuestionSurveyI} from "./QuestionSurveyI";
import {DefaultAnswerOption} from "../answeroptions/answeroption_default";

export class SurveyQuestion extends AbstractChoiceQuestion implements QuestionSurveyI {
  ...
  private _multipleSelectionEnabled: boolean;
	...
	equals (question: QuestionSurveyI): boolean {
