...
import {QuestionFreetextI} from "./QuestionFreetextI";

export class FreeTextQuestion extends AbstractQuestion implements QuestionFreetextI {
  ...
  public TYPE = 'FreeTextQuestion';
	...
	addAnswerOption (answerOption: FreeTextAnswerOption): void {
